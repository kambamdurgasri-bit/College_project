...
export default function StatisticCard({ icon: Icon, label, value, colorId = "purple" }) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-surface-light p-4 shadow-card dark:border-slate-800/80 dark:bg-surface-dark-card dark:shadow-card-dark">
