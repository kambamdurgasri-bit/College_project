...
export function SampleBadge({ text = "LearnTrack AI Auth" }) {
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-brand-50 px-2.5 py-1 text-[11px] font-medium text-brand-600 dark:bg-brand-500/15 dark:text-brand-400">
      {text}
    </span>
  );
}
